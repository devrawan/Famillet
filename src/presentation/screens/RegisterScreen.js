...
import { TextInput, ImageBackground,SafeAreaView, Text, Button, Image, StyleSheet, View, TouchableOpacity } from 'react-native';
    ...
    return (
        ...
        <SafeAreaView style={{ height: '100%', width: '100%', backgroundColor: '#0DAE9F' }}>
            ...
            <ImageBackground source={background} style={{  height: 205, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Image
                 source={{ uri:  photo} }   style={{ backgroundColor: 'white', height: 150, width: 150, borderRadius: 120, marginTop: 0 }}
                 />
                </TouchableOpacity>
            </ImageBackground>
       ...
       value={password} placeholder=" Enter your  password"  style={{marginHorizontal:10}}/>
               </View>

               <View style={styles.BoxIfo}>
               <LockIcon  name='lock' style={{color:'#D2D2D2' ,fontSize:25}}/>
                <TextInput  onChangeText={setpassword}
       value={password}  placeholder=" Confirm your password"  style={{marginHorizontal:10}}/>
               </View>
